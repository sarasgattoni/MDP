...
public class TurnProcessor {
     ...
     * The result combines the noise produced by the player's action
     * with any noise generated by an active decoy. Since the decoy
     * acts after the player action, its room becomes the latest noise
     * source when it produces noise; expired decoys are removed from the game state.
     *
